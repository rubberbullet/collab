...
class appProdProjectContainer extends Container
{
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'smarty.extension.assetic.static' => 'getSmarty_Extension_Assetic_StaticService',
            'smarty.extension.assets' => 'getSmarty_Extension_AssetsService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/apps/collab/app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $a = $this->get('templating.loader');
        $b = new \Assetic\Cache\ConfigCache('/apps/collab/app/cache/prod/assetic/config');
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), $b, false), 'smarty' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \NoiseLabs\Bundle\SmartyBundle\Assetic\SmartyFormulaLoader($this->get('templating.engine.smarty')), $b, false)));
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, '', '/apps/collab/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, '', '/apps/collab/app/Resources/views', '/\\.[^.]+\\.smarty$/'), 'smarty');
        return $instance;
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/apps/collab/app/Resources');
    ...
    {
        require_once '/apps/collab/app/cache/prod/jms_diextra/doctrine/EntityManager_5ed7f4bd6b264.php';
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_e044cd5dfed5b28783af79f7bb3f2d6c');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_e044cd5dfed5b28783af79f7bb3f2d6c');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_e044cd5dfed5b28783af79f7bb3f2d6c');
        ...
        $d->setProxyDir('/apps/collab/app/cache/prod/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager5ed7f4bd6b264_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($e, $this);
    }
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/apps/collab/app/Resources');
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/apps/collab/app/cache/prod/jms_diextra/metadata'));
        return $instance;
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('/apps/collab/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/apps/collab/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/apps/collab/app/cache/prod/sessions');
    }
    protected function getSession_Storage_FilesystemService()
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/apps/collab/app/cache/prod/sessions');
    }
    ...
    protected function getSmarty_Extension_Assetic_StaticService()
    {
        return $this->services['smarty.extension.assetic.static'] = new \NoiseLabs\Bundle\SmartyBundle\Extension\StaticAsseticExtension($this->get('smarty.extension.assets'), $this->get('assetic.asset_factory'), false, $this->get('assetic.value_supplier.default', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    protected function getSmarty_Templating_FinderService()
    {
        return $this->services['smarty.templating.finder'] = new \NoiseLabs\Bundle\SmartyBundle\CacheWarmer\SmartyTemplateFinder($this->get('kernel'), $this->get('templating.filename_parser'), '/apps/collab/app/Resources');
    }
    ...
    {
        $this->services['templating.engine.smarty'] = $instance = new \NoiseLabs\Bundle\SmartyBundle\SmartyEngine($this->get('smarty'), $this, $this->get('templating.name_parser'), $this->get('templating.loader'), array('cache_dir' => '/apps/collab/app/cache/prod/smarty/cache', 'compile_dir' => '/apps/collab/app/cache/prod/smarty/templates_c', 'config_dir' => '/apps/collab/app/config/smarty', 'default_resource_type' => 'file', 'template_dir' => '/apps/collab/app/Resources/views', 'use_include_path' => false, 'use_sub_dirs' => true), $this->get('templating.globals', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.smartybundle', ContainerInterface::NULL_ON_INVALID_REFERENCE));
        ...
        $instance->addExtension($this->get('smarty.extension.assets'));
        $instance->addExtension(new \NoiseLabs\Bundle\SmartyBundle\Extension\RoutingExtension($this->get('router')));
        ...
        $instance->addExtension($this->get('smarty.extension.assetic.static'));
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/apps/collab/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/apps/collab/app/cache/prod/translations', 'debug' => false));
    }
    protected function getTwigService()
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/apps/collab/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
        $instance->addExtension(new \Symfony\Bundle\SecurityBundle\Twig\Extension\LogoutUrlExtension($this->get('templating.helper.logout_url')));
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\SecurityExtension($this->get('security.context', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\TranslationExtension($this->get('translator')));
        $instance->addExtension(new \Symfony\Bundle\TwigBundle\Extension\AssetsExtension($this));
        $instance->addExtension(new \Symfony\Bundle\TwigBundle\Extension\ActionsExtension($this));
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/apps/collab/app', 'UTF-8'));
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), false, array(), array(), $this->get('assetic.value_supplier.default', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/apps/collab/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/apps/collab/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/apps/collab/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/apps/collab/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/apps/collab/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/apps/collab/vendor/noiselabs/smarty-bundle/NoiseLabs/Bundle/SmartyBundle/Resources/views', 'Smarty');
        $instance->addPath('/apps/collab/src/Collab/CollabBundle/Resources/views', 'Collab');
        $instance->addPath('/apps/collab/app/Resources/views');
        $instance->addPath('/apps/collab/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
        return $instance;
    }
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/apps/collab/app/../web', false);
    }
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('/apps/collab/app/cache/prod/jms_security', false));
    ...
    protected function getSmarty_Extension_AssetsService()
    {
        return $this->services['smarty.extension.assets'] = new \NoiseLabs\Bundle\SmartyBundle\Extension\AssetsExtension($this);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/apps/collab/app/cache/prod');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/apps/collab/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/apps/collab/app',
            'kernel.environment' => 'prod',
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/apps/collab/app/cache/prod',
            'kernel.logs_dir' => '/apps/collab/app/logs',
            'kernel.bundles' => array(
                ...
                'CollabBundle' => 'Collab\\CollabBundle\\CollabBundle',
            ),
            ...
            'session.save_path' => '/apps/collab/app/cache/prod/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/apps/collab/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml',
            ),
            ...
            'router.resource' => '/apps/collab/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/apps/collab/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => '/apps/collab/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/apps/collab/app/cache/prod/assetic',
            ...
            'assetic.read_from' => '/apps/collab/app/../web',
            'assetic.write_to' => '/apps/collab/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/apps/collab/app/cache/prod/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => '/apps/collab/app/cache/prod/jms_aop',
            ...
            'jms_di_extra.cache_dir' => '/apps/collab/app/cache/prod/jms_diextra',
            'jms_di_extra.disable_grep' => false,
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.cache_warmer.controller_file_blacklist' => array(
            ),
            'jms_di_extra.doctrine_integration.entity_manager.file' => '/apps/collab/app/cache/prod/jms_diextra/doctrine/EntityManager_5ed7f4bd6b264.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager5ed7f4bd6b264_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => '/apps/collab/app/cache/prod/jms_security',
            ...
            'smarty.options' => array(
                'cache_dir' => '/apps/collab/app/cache/prod/smarty/cache',
                'compile_dir' => '/apps/collab/app/cache/prod/smarty/templates_c',
                'config_dir' => '/apps/collab/app/config/smarty',
                'default_resource_type' => 'file',
                'template_dir' => '/apps/collab/app/Resources/views',
